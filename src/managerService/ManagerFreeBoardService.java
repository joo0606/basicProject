...
public class ManagerFreeBoardService {
	private ManagerFreeBoardService() {
	}// 생성자

	private static ManagerFreeBoardService instance;// 변수생성

	public static ManagerFreeBoardService getInstance() {
		if (instance == null) {
			instance = new ManagerFreeBoardService();
		}
		return instance;
	}
	...
	// 자유게시판 입장
	public int joinFree() throws Exception {
		while (true) {
 	 		System.out.println("─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────");
	...
	private void selectfree() throws Exception {
		...
		for (int i = 0; i < list1.size(); i++) {
			...
			while (true) {
				System.out.println();
				System.out.println("------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
				System.out.println("\t1.댓글쓰기\t 2.댓글수정\t 3.댓글삭제\t 4.돌아가기");
				System.out.print("번호를 입력해주세요>");
				int input = sc.nextInt();
				System.out.println("------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");			
				switch (input) {
